    ...
    <Layout>
      <Container maxW="80%" px={4} mt={{ base: -24, md: -28 }} mb={70}>
        ...
        <Section delay={0.1}>
          ...
          >
            Get in touch with me for collaborations, questions, offers, or just to say hi!{" "} <Link as={NextLink} href="/privacy" passHref scroll={false}  fontFamily={process.env.NEXT_PUBLIC_HEADING_H2_FONT} color={useColorModeValue(process.env.NEXT_PUBLIC_LINK_COLOR_LIGHT, process.env.NEXT_PUBLIC_LINK_COLOR_DARK)}>
