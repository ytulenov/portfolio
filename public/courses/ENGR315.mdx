...
*ENGR 315: Systems and Control* is a third-year course, taught by Dr. Klaske van Heusden, introducing control systems engineering. Lectures run twice weekly (Tuesdays and Thursdays, 9:30–11:00 a.m. for Section 201, 2:00–3:30 p.m. for Section 202), with biweekly labs and weekly tutorials starting mid-January. The course covers dynamic system modeling, stability analysis, and controller design using tools like MATLAB and Simulink. Assessments include labs, assignments, a midterm (March 5), and a final exam, blending theory with practical application.
