...
*ENGR_O 480: Modern Control* is a fourth-year course at UBC Okanagan, taught by Dr. Mehran Shirazi, focusing on state-space methods for control system design. Lectures run twice weekly (Tuesdays and Thursdays, 9:30–11:00 a.m.) in LIB-305 from September 3 to December 6, 2024. The course dives into linear algebra, state-space modeling, stability, and feedback design, with practical MATLAB implementation. Assessments include assignments, a project, a midterm (November 5), and a final exam, emphasizing both theory and application in engineering systems.
