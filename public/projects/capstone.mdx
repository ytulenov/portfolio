...
<div  style={{ textAlign: "center"}} height="100%" width="100%">
  ...
  >
    <source src="/images/projects/capstonefootage/Capstone_Video_1.mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
</div>
<div style={{ textAlign: "center", fontStyle: "italic", fontSize: "0.9em", color: "#666", marginBottom: "20px" }}>
